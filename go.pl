...
var chart = new google.visualization.LineChart(document.getElementById('curve_chart1_$ftp'));
...
var chart = new google.visualization.LineChart(document.getElementById('curve_chart2_$ftp'));
...
<body>
<div id="curve_chart1_$ftp" style="width: 900px; height: 500px"></div>
<div id="curve_chart2_$ftp" style="width: 900px; height: 500px"></div>
</body>
</html>
